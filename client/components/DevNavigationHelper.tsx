    ...
    <Card className="w-full max-w-4xl mx-auto mt-8">
      ...
      <CardContent className="space-y-6">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-blue-600 mt-1">{route.path}</div>
                    </div>
                  </div>
        ...
        <Alert>
          ...
          <AlertDescription>
            <strong>Quick Setup:</strong> For bucket creation, use <code>/auth-test</code> → Storage tab → "Initialize Buckets" button.
