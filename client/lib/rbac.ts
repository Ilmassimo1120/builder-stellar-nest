...
export const canViewAllUsers = (role: UserRole) =>
  rbacService.hasPermission(role, "users.view.all");
export const canManageProducts = (role: UserRole) =>
  rbacService.hasPermission(role, "products.edit");
export const canViewAllQuotes = (role: UserRole) =>
  rbacService.hasPermission(role, "quotes.view.all");
export const canApproveQuotes = (role: UserRole) =>
  rbacService.hasPermission(role, "quotes.approve");
export const canCompareProducts = (role: UserRole) =>
  rbacService.hasPermission(role, "quotes.compare");
export const canManageSettings = (role: UserRole) =>
  rbacService.hasPermission(role, "settings.edit");
export const canViewAnalytics = (role: UserRole) =>
  rbacService.hasPermission(role, "analytics.view");
