...
class ProductCatalogService {
  ...
  private initializeProducts(): void {
    this.products = [
      // AC Chargers - Residential
      {
        ...
        description:
          "Smart EV charger with solar integration and load balancing. Perfect for home installations with renewable energy systems.",
        category: "chargers",
      ...
      },
      {
        ...
        description:
          "Three-phase AC charging station with OCPP compliance. Ideal for commercial and residential applications.",
        category: "chargers",
      ...
      },
      {
        ...
        description:
          "Tesla's latest generation wall connector with Wi-Fi connectivity and power sharing capabilities.",
        category: "chargers",
        subcategory: "ac-chargers-residential",
        brand: "Tesla",
      ...
      // DC Fast Chargers
      {
        ...
        description:
          "Compact 50kW DC fast charger with dual connector support (CCS2 + CHAdeMO). Perfect for public and semi-public locations.",
        category: "chargers",
        ...
        documents: [
          "/docs/abb-terra54-datasheet.pdf",
          "/docs/abb-terra54-installation.pdf",
        ],
        isActive: true,
        createdAt: "2024-01-15T10:00:00Z",
        updatedAt: "2024-01-15T10:00:00Z",
      },
      {
        ...
        description:
          "Australian-made 50kW DC fast charger with robust design for harsh outdoor conditions.",
        category: "chargers",
        subcategory: "dc-fast-chargers",
        brand: "Tritium",
        model: "PK50",
      ...
      // Ultra-Fast Chargers
      {
        ...
        description:
          "Next-generation 360kW ultra-fast charger capable of charging up to 4 vehicles simultaneously.",
        category: "chargers",
      ...
      // Accessories
      {
        ...
        description:
          "High-quality Type 2 to Type 2 charging cable rated for 32A single-phase charging.",
      ...
      },
      {
        ...
        description:
          "Universal adjustable wall mounting bracket suitable for most AC charging stations.",
        category: "accessories",
      ...
      // Safety Equipment
      {
        ...
        description:
          "Residual Current Breaker with Overcurrent protection specifically designed for EV charging applications.",
        category: "accessories",
      ...
      // Installation Services
      {
        ...
        description:
          "Professional installation service for AC chargers up to 22kW including electrical work and commissioning.",
        category: "services",
  ...
  getPowerRatings(): string[] {
    const ratings = [
      ...new Set(
        this.products.map((p) => p.specifications.powerRating).filter(Boolean),
      ),
    ] as string[];
    return ratings.sort();
  }
  ...
  reorderCategoriesForUser(userId: string, categoryIds: string[]): boolean {
    return userPreferencesService.setCategoryOrder(userId, categoryIds);
  }
