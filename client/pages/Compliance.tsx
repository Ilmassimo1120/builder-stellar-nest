  ...
  const standards = [
    {
      ...
      description: "The fundamental electrical installation standard for Australia and New Zealand, covering all aspects of electrical wiring and safety.",
      keyRequirements: [
      ...
      applicableTo: ["Residential installations", "Commercial installations", "Industrial installations", "EV charging infrastructure"],
    ...
    },
    {
      ...
      description: "Specific requirements for electric vehicle supply equipment (EVSE) and charging infrastructure.",
      keyRequirements: [
      ...
      applicableTo: ["EV charging stations", "Home charging units", "Public charging infrastructure", "Fleet charging systems"],
    ...
    },
    {
      ...
      description: "Guidelines for selecting appropriate cables for electrical installations, including high-power EV charging applications.",
      keyRequirements: [
      ...
      applicableTo: ["Cable installations", "High-power applications", "EV charging circuits", "Industrial installations"],
    ...
    },
    {
      ...
      description: "Requirements for demand response capabilities in electrical equipment, including smart EV charging systems.",
      keyRequirements: [
      ...
      applicableTo: ["Smart EV chargers", "Load management systems", "Grid-connected equipment", "Commercial installations"],
      downloadUrl: "#as-4755",
      color: "primary",
    },
  ];
  ...
  const tools = [
    {
      ...
      description: "Generate customized compliance checklists for your EV installation projects",
      icon: <CheckCircle2 className="w-8 h-8 text-primary" />,
      features: ["State-specific requirements", "Project type customization", "PDF export", "Progress tracking"],
      action: "Generate Checklist",
    },
    {
      title: "Standards Library",
      description: "Access to complete Australian electrical standards and regulations",
      icon: <Book className="w-8 h-8 text-secondary" />,
      features: ["Latest standards", "Search functionality", "Bookmark favorites", "Update notifications"],
    ...
    },
    {
      ...
      features: ["Digital forms", "Photo attachments", "Signature capture", "Cloud sync"],
      action: "Download Forms",
    },
    {
      title: "Compliance Calendar",
      description: "Track compliance deadlines, renewals, and training requirements",
      icon: <Calendar className="w-8 h-8 text-primary" />,
      features: ["Deadline tracking", "Renewal reminders", "Training schedules", "Team coordination"],
  ...
  const updates = [
    {
      ...
      description: "New requirements for EV charging installations and updated testing procedures.",
      impact: "High",
    ...
    },
    {
      ...
      description: "Energy Safe Victoria updates prescribed electrical work requirements for EV charging.",
      impact: "Medium",
    ...
    },
    {
      ...
      description: "Industry guidance on Type A RCD requirements for EV charging installations.",
      impact: "Medium",
      action: "Review RCD selection criteria",
    },
  ];

  const filteredRegulations = selectedState === "all" 
    ? stateRegulations 
      ...
      <main>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary/10 to-secondary/10">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Stay compliant with Australian electrical standards and regulations for EV charging infrastructure. 
              Access the latest requirements, guidelines, and tools to ensure safe and compliant installations.
            </p>
            ...
            <Alert className="max-w-2xl mx-auto mb-8">
              ...
              <AlertDescription>
                Our compliance information is updated regularly to reflect the latest standards and regulations. 
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8 bg-muted/50">
          <div className="container mx-auto">
            <h2 className="text-2xl font-bold mb-6">Recent Compliance Updates</h2>
        ...
        <section id="standards" className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Australian Electrical Standards</h2>
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Comprehensive overview of electrical standards applicable to EV charging infrastructure
              </p>
            </div>
              ...
              {standards.map((standard) => (
                <Card key={standard.id} className="h-full">
                  <CardHeader>
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex-1">
                        ...
                        <CardDescription className="text-base font-medium">{standard.subtitle}</CardDescription>
                        <Badge variant="outline" className="mt-2">{standard.category}</Badge>
                      </div>
                      <div className="text-right">
                        <p className="text-sm text-muted-foreground">Updated</p>
                        <p className="text-sm font-medium">{standard.lastUpdated}</p>
                      </div>
                    </div>
                  </CardHeader>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div>
                      <h4 className="font-semibold text-sm mb-3">Key Requirements:</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-sm mb-3">Applicable To:</h4>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/50">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">State & Territory Regulations</h2>
              <p className="text-muted-foreground text-lg">
                Specific requirements and regulations for each Australian state and territory
              </p>
            </div>
            ...
            <div className="flex justify-center mb-8">
              <div className="flex flex-wrap gap-2">
                ...
                {stateRegulations.map((state) => (
                  <Button
                    key={state.state}
                    variant={selectedState === state.state ? "default" : "outline"}
                    size="sm"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {filteredRegulations.map((regulation) => (
                <Card key={regulation.state}>
                  ...
                  <CardContent className="space-y-6">
                    <div>
                      <h4 className="font-semibold text-sm mb-3">General Requirements:</h4>
                      <ul className="space-y-2">
                    ...
                    <div>
                      <h4 className="font-semibold text-sm mb-3">EV Specific Requirements:</h4>
                      <ul className="space-y-2">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <a href={regulation.website} className="text-primary hover:underline">
                            Official Website
                          </a>
                        </div>
                      </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">EV Installation Compliance Checklist</h2>
              <p className="text-muted-foreground text-lg">
                Comprehensive checklist to ensure your EV charging installations meet all requirements
              </p>
            </div>
        ...
        <section id="tools" className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/50">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg">
                Streamline your compliance processes with our specialized tools and resources
              </p>
            </div>
            ...
            <Card className="bg-gradient-to-r from-primary to-secondary text-white">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-xl mb-8 text-primary-foreground/90 max-w-2xl mx-auto">
                  Our team of compliance experts is here to help you navigate complex regulations 
                  and ensure your EV installations meet all requirements.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link to="/compliance#standards" className="hover:text-foreground">Standards</Link></li>
                <li><Link to="/compliance#regulations" className="hover:text-foreground">Regulations</Link></li>
                <li><Link to="/compliance#tools" className="hover:text-foreground">Tools</Link></li>
                <li><Link to="/compliance#updates" className="hover:text-foreground">Updates</Link></li>
              </ul>
            </div>
            <div>
