...
export default function DashboardWorking() {
  ...
  const recentProjects = [
    { id: 1, name: "Tesla Supercharger - Mall", status: "In Progress", completion: 75 },
    { id: 2, name: "Office Building EV Hub", status: "Planning", completion: 25 },
    { id: 3, name: "Residential Installation", status: "Completed", completion: 100 },
    { id: 4, name: "Hotel Charging Station", status: "In Progress", completion: 60 },
  ];

  const pendingQuotes = [
    { id: 1, client: "ABC Corp", amount: "$12,500", created: "2 days ago" },
    { id: 2, client: "XYZ Ltd", amount: "$8,900", created: "1 week ago" },
    { id: 3, client: "Green Energy Co", amount: "$25,000", created: "3 days ago" },
  ];
