  ...
  const runIntegrationTest = async () => {
    ...
    try {
      ...
      if (evnetProduct) {
        ...
        results.push(
          `   - Category: ${evnetProduct.category}/${evnetProduct.subcategory}`,
        );
      ...
      if (testQuote) {
        ...
        const evnetLineItem = updatedQuote?.lineItems.find((item) =>
          item.name.includes("EVNet"),
        );
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            Charge N Go EVNet Chargepoint Management Platform
          </CardTitle>
          <CardDescription>
            Testing the integration of the new EVNet service with the quoting
          ...
          {evnetProduct ? (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <div className="mt-2 space-y-1 text-sm text-green-700">
                <p>
                  <strong>Name:</strong> {evnetProduct.name}
                </p>
                <p>
                  <strong>SKU:</strong> {evnetProduct.sku}
                </p>
                <p>
                  <strong>Category:</strong> {evnetProduct.category}/
                  {evnetProduct.subcategory}
                </p>
                <p>
                  <strong>Price:</strong> $
                  {evnetProduct.pricing.recommendedRetail}
                </p>
                <p>
                  <strong>Description:</strong> {evnetProduct.description}
                </p>
              </div>
            </div>
          ) : (
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2 text-sm">
            <p>
              ✅ <strong>Product Catalog:</strong> EVNet service added with
              comprehensive specifications
            </p>
            <p>
              ✅ <strong>Category System:</strong> New "management-platform"
              subcategory created
            </p>
            <p>
              ✅ <strong>Project Templates:</strong> Commercial, retail, and
              fleet templates updated
            </p>
            <p>
              ✅ <strong>Quote Integration:</strong> Automatic addition when
              project includes EVNet
            </p>
            <p>
              ✅ <strong>Manual Addition:</strong> Service can be manually added
              to any quote
            </p>
          </div>
        </CardContent>
