...
export default function TestStatus() {
  ...
  const runComprehensiveTests = async () => {
    ...
    try {
      const { safeFileStorageService } = await import(
        "@/lib/services/safeFileStorageService"
      );
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {testResults.length === 0 ? (
                <Alert>
                  <AlertDescription>
                    Click "Run All Tests" to perform comprehensive system
                    testing
                  </AlertDescription>
                </Alert>
              ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div>
                  📧 <code>admin@chargesource.com.au</code> → Admin role
                </div>
                <div>
                  📧 <code>globaladmin@chargesource.com.au</code> → Global Admin
                </div>
                <div>
                  📧 <code>sales@chargesource.com.au</code> → Sales role
                </div>
                <div>
                  📧 <code>partner@company.com</code> → Partner role
                </div>
                <div>
                  📧 <code>user@demo.com</code> → Regular user
                </div>
              </div>
            </div>
            <div>
