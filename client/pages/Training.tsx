...
export default function Training() {
  ...
  const learningPaths = [
    ...
    },
    {
      ...
      description: "Advanced planning, compliance, and project management skills",
      level: "Intermediate",
      duration: "18 hours",
      courses: 8,
      certification: true,
    ...
    },
    {
      ...
      description: "Complex installations, fleet management, and enterprise solutions",
      level: "Advanced",
      duration: "24 hours",
      courses: 10,
      certification: true,
    ...
    },
    {
      ...
      description: "Growing your EV contracting business and maximizing profitability",
      level: "Business",
      duration: "15 hours",
      courses: 7,
      certification: false,
  ...
  const featuredCourses = [
    {
      ...
      description: "Learn to conduct thorough site assessments, identify potential challenges, and develop solutions for EV charging installations.",
      modules: [
    ...
    },
    {
      ...
      thumbnail: "/api/placeholder/400/225",
      description: "Master Australian electrical standards and ensure all your EV installations meet regulatory requirements.",
      modules: [
    ...
    },
    {
      ...
      thumbnail: "/api/placeholder/400/225",
      description: "Get the most out of ChargeSource's Configure, Price, Quote system to create accurate estimates and win more projects.",
      modules: [
        "CPQ system overview",
  ...
  const certifications = [
    {
      ...
      description: "Demonstrate your expertise in EV charging infrastructure planning and installation",
      requirements: ["Complete Fundamentals path", "Pass final exam (80%+)", "Submit 3 project case studies"],
      badge: "CEVIS",
      validity: "2 years",
    ...
    },
    {
      ...
      description: "Advanced certification for managing complex EV infrastructure projects",
      requirements: ["Complete Project Planning path", "5+ years experience", "Pass comprehensive exam"],
      badge: "AEPM",
      validity: "3 years",
    ...
    },
    {
      ...
      requirements: ["Complete all platform courses", "Pass practical assessment", "Mentor 2 new users"],
      badge: "CSPE",
      validity: "1 year",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link to="/help-centre" className="text-muted-foreground hover:text-foreground">
                Help Centre
              </Link>
            </nav>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary/10 to-secondary/10">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Master the skills you need to succeed in the growing EV infrastructure market. 
          ...
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Structured learning journeys designed to take you from beginner to expert in EV infrastructure
              </p>
            </div>
          ...
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg">
                Popular courses chosen by our community of electrical contractors
              </p>
            </div>
        ...
        <section id="certifications" className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Earn industry-recognized certifications to validate your expertise and advance your career
              </p>
            </div>
          ...
          <div className="container mx-auto">
            <div className="flex flex-col lg:flex-row gap-12">
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 text-sm">
                              <span className="text-green-600">{webinar.registered} registered</span>
                              <span className="text-muted-foreground">{webinar.spots} spots left</span>
                            </div>
                          </div>
              ...
              <div className="lg:w-1/3">
                <h3 className="text-xl font-semibold mb-6">Training Resources</h3>
                <div className="space-y-4">
                ...
                <Card className="mt-6">
                  <CardHeader>
                    <CardTitle className="text-lg">Need Custom Training?</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm text-muted-foreground mb-4">
                      We offer customized training programs for teams and organizations.
                    </p>
            ...
            <Card className="bg-gradient-to-r from-primary to-secondary text-white">
              <CardContent className="p-12">
                ...
                <p className="text-xl mb-8 text-primary-foreground/90 max-w-2xl mx-auto">
                  Join hundreds of electrical contractors who have already enhanced their skills 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link to="/training" className="hover:text-foreground">Learning Paths</Link></li>
                <li><Link to="/training#certifications" className="hover:text-foreground">Certifications</Link></li>
                <li><Link to="/training#webinars" className="hover:text-foreground">Webinars</Link></li>
                <li><Link to="/training#resources" className="hover:text-foreground">Resources</Link></li>
              </ul>
            </div>
            <div>
