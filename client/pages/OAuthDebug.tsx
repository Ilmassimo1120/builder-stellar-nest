          ...
          <CardContent className="space-y-3">
            ...
            <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <ol className="list-decimal list-inside text-sm text-blue-700 space-y-1">
                ...
                <li>
                  Add the redirect URIs above to "Authorized redirect URIs"
                </li>
            ...
            {testResults && !testResults.loading && (
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <Badge
                    variant={
                      testResults.supabaseConnection ? "default" : "destructive"
                    }
                  >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Badge
                    variant={
                      testResults.oauthConfigured ? "default" : "destructive"
                    }
                  >
                    {testResults.oauthConfigured
                      ? "Configured"
        ...
        <Card>
          ...
          <CardContent>
            <Alert>
              <AlertTriangle className="h-4 w-4" />
              <AlertDescription>
                After configuring both Google Cloud Console and Supabase, test
                the OAuth flow:
              </AlertDescription>
            </Alert>
