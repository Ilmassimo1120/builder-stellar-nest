...
import { mockLocalStorage, mockGoogleMaps, createTestProject, createTestUser } from '../../lib/testing';
...
describe('Projects Component', () => {
  ...
  it('opens project details modal', async () => {
    ...
    // Modal should open
    await waitFor(() => {
      expect(screen.getByText('Project details and site information')).toBeInTheDocument();
    });
  });
  ...
  it('shows map view when selected', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('Interactive map showing all project sites')).toBeInTheDocument();
    });
  });
});
