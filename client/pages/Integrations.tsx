...
const Integrations = () => {
  ...
  const featuredIntegrations = [
    ...
    },
    {
      ...
      logo: "https://via.placeholder.com/60x60/635BFF/FFFFFF?text=ST",
      isPopular: false,
      rating: 4.9,
      reviews: 3200,
      features: ["Secure payments", "Multi-currency", "Subscription billing", "Mobile payments"],
    ...
    },
    {
      ...
      rating: 4.6,
      reviews: 890,
      features: ["Real-time alerts", "Project updates", "Team notifications", "Custom channels"],
      setupTime: "3 minutes",
      tier: "free",
    },
  ];
