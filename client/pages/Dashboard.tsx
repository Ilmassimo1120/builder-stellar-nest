...
export default function Dashboard() {
  const { user, logout, hasPermission, isAdmin, isGlobalAdmin } = useAuth();
                          ...
                          <div className="flex-1">
                            ...
                            <div className="mt-3">
                              <Progress
                                ...
                                className="h-2 w-[90%]"
                              />
                              <div className="flex items-center justify-between text-sm mt-1 w-[90%]">
                                <span>Progress</span>
        ...
        {(isAdmin || isGlobalAdmin) && (
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>
                Manage and upload documents, manuals, and training materials to
                the knowledge base
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <Button asChild className="h-auto p-4">
                  ...
                  >
                    ...
                    <span className="text-sm text-left opacity-90">
                      Add documents, manuals, and training videos to the
                      knowledge base
                    </span>
                  </Link>
                </Button>
                    ...
                    onClick={() => {
                      ...
                      if (supportButton) {
                        ...
                        window.dispatchEvent(
                          new CustomEvent("openSupportAssistant"),
                        );
                      }
                    }}
                  >
