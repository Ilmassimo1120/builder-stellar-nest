  ...
  const featuredCourses = [
    {
      ...
      level: "Intermediate",
      type: "Video Course",
      description: "Learn to conduct thorough site assessments and identify potential challenges for EV charging installations.",
    },
    {
    ...
    },
    {
      ...
      description: "Get the most out of ChargeSource's tools to create accurate estimates and manage projects effectively.",
    },
  ];
  ...
  const benefits = [
    {
      ...
      description: "Earn certifications recognized across the Australian EV industry",
    },
    {
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Comprehensive, practical training designed specifically for the Australian EV market
              </p>
            </div>
